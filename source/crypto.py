...
def ohlcvsave(): #function for saving ohclv csv files
    ...
    Mdfohlcv['Time'] = pd.to_datetime(Mdfohlcv['Time'], unit='ms')
    mdfohlcv.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/minuteohlcv.csv', header=True)
    hdfohlcv.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/hourohlcv.csv', header=True)
    ddfohlcv.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/dayohlcv.csv', header=True)
    Mdfohlcv.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/monthohlcv.csv', header=True)
...
def testemacheck(dfsignal, testUSDbalance,testBTCbalance):
    ...
    if exchange.has['fetchOHLCV']:
        ...
        dfohlcv.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/ohlcv.csv', header=True)
    ...
    print(dfsignal)
    dfsignal.to_csv (r'/Users/jae/Documents/Programming/algotrade/source/data/0.5signal.csv', header=True)
